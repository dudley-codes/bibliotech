...
export default function Register() {
  ...
  const registerClick = (e) => {
    ...
    if (password && password !== confirmPassword) {
      ...
      const userProfile = { firstName, lastName, imageUrl, city, state, email };
        ...
        <Form onSubmit={ registerClick }>
          <fieldset>
            ...
            <FormGroup>
              ...
              <Input id="email" autoComplete='off' type="text" onChange={ e => setEmail(e.target.value) } />
            </FormGroup>
            <FormGroup>
            ...
            <FormGroup>
              <Button variant='search'>Register</Button>
            </FormGroup>
          </fieldset>
        </Form>
      </div>
